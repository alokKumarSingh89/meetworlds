...
export type Action = UpdatePurchaseSuccess | UpdatePurchaseRequest | GetAllPurchaseRequest | GetAllPurchaseSuccess | CreatePurchaseRequest | CreatePurchaseSuccess
